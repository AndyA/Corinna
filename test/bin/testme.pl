...
use Corinna;
use Corinna::Util	qw(slurp_file);
use Data::Dumper;
...
sub test_pastor() {	
	...
	print "\n\n******* FILE SYSTEM ****************************";
	$country = Corinna::Test::country->from_xml(URI::file->new_abs('./test/source/country/xml/country.xml'));
	...
	$country = Corinna::Test::country->from_xml($fh);
	test_country($country);		

	print "\n\n******* STRING ****************************";
	my $str = slurp_file("./test/source/country/xml/country.xml");
	$country = Corinna::Test::country->from_xml($str);
	test_country($country);		
...
#	print "\n\n******* HTTP ***********************************";
#	$country = Corinna::Test::country->from_xml('http://test.dev.vedora.org/ayhan/workspace/XML-Pastor/test/xml/country.xml');
#	test_country($country);					
}
