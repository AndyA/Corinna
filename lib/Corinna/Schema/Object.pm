...
Corinna::Schema::Object->mk_accessors(qw(class definition documentation isRedefinable metaClass name nameIsAutoGenerated ref refKey scope type targetNamespace));
