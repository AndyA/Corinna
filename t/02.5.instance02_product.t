...
my $product =
  Corinna::Test::MathWorks::product->from_xml(
    URI::file->new_abs('./test/source/mathworks/xml/mProduct.xml') );
...
is( $product->requiredProducts->productDep->name,
    'tester', "Required products" );
is( $product->recommendedProducts->productDep->name,
    'testerExtension', "Recommended products" );
