...
my $country_in = $country_class->from_xml(
    URI::file->new_abs('./test/source/country/xml/country.xml') );

$country_in->to_xml_file('./test/out/country.xml');
my $country_out = $country_class->from_xml_file('./test/out/country.xml');

$country_in->to_xml_file( './test/out/country_latin1.xml',
    encoding => 'iso-8859-1' );
my $country_latin1 =
  $country_class->from_xml_file('./test/out/country_latin1.xml');
