...
# ======= COUNTRY ==============				
my $country_in = Corinna::Test::country->from_xml(URI::file->new_abs('./test/source/country/xml/country_import.xml'));

$country_in->to_xml_file('./test/out/country_import.xml');
my $country_out = Corinna::Test::country->from_xml_file('./test/out/country_import.xml');

$country_in->to_xml_file('./test/out/country_import_latin1.xml', encoding => 'iso-8859-1');
my $country_latin1 = Corinna::Test::country->from_xml_file('./test/out/country_import_latin1.xml');
